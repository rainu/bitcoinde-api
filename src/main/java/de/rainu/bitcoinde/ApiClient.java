...
import de.rainu.bitcoinde.auth.ApiKeyAuth;
import de.rainu.bitcoinde.auth.Authentication;
import de.rainu.bitcoinde.auth.HttpBasicAuth;
import de.rainu.bitcoinde.auth.OAuth;
import java.io.File;
...
public class ApiClient {
  ...
  public ApiClient() {
    ...
    authentications.put("apiNonce", new ApiKeyAuth("header", "X-API-NONCE"));
    authentications.put("apiSignature", new ApiKeyAuth("header", "X-API-SIGNATURE"));
