...
import de.rainu.bitcoinde.model.TradeState;
...
public class TradesApi {
   ...
   */
  public ExecuteTradeResponse executeTrade(String tradeId, TradingPair tradingPair, BuyOrSell type,
      Float amount) throws ApiException {
    Object localVarPostBody = null;

    // verify the required parameter 'tradeId' is set
    if (tradeId == null) {
      throw new ApiException(400,
          "Missing the required parameter 'tradeId' when calling executeTrade");
    }

    // verify the required parameter 'tradingPair' is set
    if (tradingPair == null) {
      throw new ApiException(400,
          "Missing the required parameter 'tradingPair' when calling executeTrade");
    }

    // verify the required parameter 'type' is set
    if (type == null) {
      throw new ApiException(400,
          "Missing the required parameter 'type' when calling executeTrade");
    }

    // verify the required parameter 'amount' is set
    if (amount == null) {
      throw new ApiException(400,
          "Missing the required parameter 'amount' when calling executeTrade");
    }

    // create path and map variables
    final String localVarPath = "/trades/{trade_id}"
  ...
  public ShowMyTradeDetailsResponse showMyTradeDetails(String tradeId) throws ApiException {
    ...
    if (tradeId == null) {
      throw new ApiException(400,
          "Missing the required parameter 'tradeId' when calling showMyTradeDetails");
    }
   ...
   * @param dateStart Startzeitpunkt, ab dem Trades zurückgeliefert werden. Format gemäß RFC 3339
   * (Bsp: 2015-01-20T15:00:00+02:00). (optional)
   * @param dateEnd Endzeitpunkt, bis zu dem Trades zurückgeliefert werden. Format gemäß RFC 3339
   * (Bsp: 2015-01-20T15:00:00+02:00). (optional)
   * @param page Seitenzahl zum Blättern innerhalb der Ergebnisseiten (optional, default to 1)
   * @return ShowMyTradesResponse
   * @throws ApiException if fails to make API call
   */
  public ShowMyTradesResponse showMyTrades(BuyOrSell type, TradingPair tradingPair,
      TradeState state, DateTime dateStart, DateTime dateEnd, Integer page) throws ApiException {
    Object localVarPostBody = null;

    // create path and map variables
    final String localVarPath = "/trades";
  ...
  /**
   * Erfolgreich abgeschlossene Trades. Wenn kein Parameter gesetzt wird, werden alle erfolgreich
   * abgeschlossenen Trades der letzten 7 Tage zurückgeliefert. Die Liste ist absteigend nach Datum
   * sortiert.
   *
   * @param tradingPair Handelspaar (required)
   ...
   * @throws ApiException if fails to make API call
   */
  public ShowPublicTradeHistoryResponse showPublicTradeHistory(TradingPair tradingPair, Integer sinceTid)
      throws ApiException {
    Object localVarPostBody = null;
    ...
    if (tradingPair == null) {
      throw new ApiException(400,
          "Missing the required parameter 'tradingPair' when calling showPublicTradeHistory");
    }

    // create path and map variables
    final String localVarPath = "/trades/history";
